...
[@co-panion/database](../../../../README.md) / [Prisma](../README.md) / UserDelegate

# Interface: UserDelegate\<ExtArgs, GlobalOmitOptions\>

Defined in: libs/database/src/generated/prisma/index.d.ts:2865
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3237
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3156
...
> **count**\<`T`\>(`args?`): [`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`T` *extends* `Record_2`\<`"select"`, `any`\> ? `T`\[`"select"`\] *extends* `true` ? `number` : \{ \[P in string \| number \| symbol\]: P extends keyof UserCountAggregateOutputType ? UserCountAggregateOutputType\[P\] : never \} : `number`\>

Defined in: libs/database/src/generated/prisma/index.d.ts:3122
...
[`PrismaPromise`](../type-aliases/PrismaPromise.md)\<`T` *extends* `Record_2`\<`"select"`, `any`\> ? `T`\[`"select"`\] *extends* `true` ? `number` : \{ \[P in string \| number \| symbol\]: P extends keyof UserCountAggregateOutputType ? UserCountAggregateOutputType\[P\] : never \} : `number`\>
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2955
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2969
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2993
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3007
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3038
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2907
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2923
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2941
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2878
...
Defined in: libs/database/src/generated/prisma/index.d.ts:2892
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3176
...
`OrderFields` *extends* `"id"` \| `"shelterId"` \| `"email"` \| `"password"` \| `"nickname"` \| `"role"` \| `"imgProfile"` \| `"status"` \| `"createdAt"` \| `"updatedAt"`
...
\{ \[key in string \| number \| symbol\]: key extends keyof UserGroupByArgs\<DefaultArgs\> ? T\[key\] : never \} & `OrderByArg` & `InputErrors`
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3024
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3057
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3087
...
Defined in: libs/database/src/generated/prisma/index.d.ts:3106
